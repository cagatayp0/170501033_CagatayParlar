...
public class InsertTest {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Student s2 = new Student("Richard", "Rich", "170501033");
        boolean inserted2 = manager.insert(s2);
        System.out.println("Inserted: " + inserted2);
        
        Student s3 = new Student("Lebron", "James", "170501038");
        boolean inserted3 = manager.insert(s3);
